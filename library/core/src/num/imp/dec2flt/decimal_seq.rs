...
impl DecimalSeq {
    ...
    pub fn trim(&mut self) {
        ...
        // Clamp to MAX_DIGITS to prevent out-of-bounds access if the
        // debug_assert invariant is ever violated by a new caller.
        self.num_digits = self.num_digits.min(Self::MAX_DIGITS);
